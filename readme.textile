...
2. Open the @/theme@ folder and add the following strings to the @<head>@ section  of the layout files in the current theme:
...
* Enter the following text in the Content field:
<pre><code>
